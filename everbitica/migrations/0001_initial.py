# Generated by Django 3.2.25 on 2024-05-08 01:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Book',
            fields=[
                ('name', models.CharField(default='', max_length=30, primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('int', models.PositiveIntegerField(db_column='int', default=0)),
                ...
                ('mailkey', models.CharField(default='', max_length=16)),
        ...
        migrations.CreateModel(
            name='LootdropEntry',
            fields=[
                ('lootdrop', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='everbitica.lootdrop')),
        ...
        migrations.CreateModel(
            name='LoottableEntry',
            fields=[
                ('loottable', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='everbitica.loottable')),
                ('multiplier', models.SmallIntegerField(default=1)),
        ...
        migrations.AddIndex(
            model_name='zone',
            index=models.Index(fields=['zoneidnumber'], name='eq_zone_zoneidn_afacd8_idx'),
        ),
        migrations.AddIndex(
            model_name='zone',
            index=models.Index(fields=['short_name'], name='eq_zone_short_n_86b6d6_idx'),
        ),
        ...
        migrations.AddField(
            ...
            name='character_data',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='everbitica.characterdata'),
        ),
        migrations.AddField(
            model_name='characterspell',
            name='spell',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='everbitica.spell'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='characterskill',
            name='skill',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='everbitica.skill'),
        ),
        migrations.AddField(
            model_name='charactermemmedspell',
            name='character_data',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='everbitica.characterdata'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='characterinventory',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='everbitica.item'),
        ),
        migrations.AddField(
            model_name='characterfactionvalue',
            name='character_data',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='everbitica.characterdata'),
        ),
        migrations.AddField(
            model_name='characterfactionvalue',
            name='faction',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='everbitica.faction'),
        ),
        migrations.AddField(
            model_name='charactercurrency',
            name='character_data',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='everbitica.characterdata'),
        ),
        migrations.AddField(
            model_name='characterbuff',
            name='character_data',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='everbitica.characterdata'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='lootdrop',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='everbitica.lootdrop'),
        ),
        migrations.AddField(
            model_name='lootdropentry',
            name='item',
            field=models.ForeignKey(db_column='item_id', default=0, on_delete=django.db.models.deletion.CASCADE, to='everbitica.item'),
        ),
        migrations.AlterUniqueTogether(
            name='characterspell',
            unique_together={('slot_id', 'character_data'), ('spell', 'character_data')},
        ),
        migrations.AlterUniqueTogether(
            name='characterskill',
        ...
        migrations.AlterUniqueTogether(
            name='charactermemmedspell',
            unique_together={('spell', 'character_data'), ('character_data', 'slot_id')},
        ),
        migrations.AlterUniqueTogether(
            name='characterinventory',
        ...
        migrations.AlterUniqueTogether(
            name='characterbuff',
            unique_together={('character_data', 'spell'), ('character_data', 'slot_id')},
        ),
        migrations.AlterUniqueTogether(
            name='loottableentry',
