...
class Command(BaseCommand):
    help = "Seeds the database with additional EQ data that isn't in original SQL import"
    ...
    def handle(self, *args, **options):
        ...
        for class_data in classes:
            CharacterClass.objects.create(id=class_data[0], bitmask=class_data[1], name=class_data[2], spell_list_id=class_data[3])
